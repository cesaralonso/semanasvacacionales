...
<div style="background-color:#E3E5E7;"><!--[if mso | IE]>
    ...
    <table border="0" cellpadding="0" cellspacing="0"><tr><td style="vertical-align:top;width:600px;">
    <![endif]-->
      <form action="http://0.0.0.0:3000/api/People/verifyEmail/lel" method="POST">
                        ...
                        <table cellpadding="0" cellspacing="0" align="center" border="0">
                            <tbody>
                                <tr><td style="border-radius:3px;color:white;cursor:auto;" align="center" valign="middle" bgcolor="#163862">
                                    <a href="#" style="display:inline-block;text-decoration:none;background:#163862;border-radius:3px;color:white;font-family:\'Avenir Next\', Avenir, sans-serif;font-size:14px;font-weight:500;line-height:35px;padding:10px 25px;margin:0px;" target="_blank">
                                        VERIFICAR MI CUENTA
                                    </a>
                                </td></tr>
                            </tbody>
